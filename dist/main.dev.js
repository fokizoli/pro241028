...
var PI = 3.14;
befogo = 12; //fő egyszerű adattípusok - szám(number), szöveg(string), logikai(boolean)
...
var tomb = [123, "szöveg", true, "körte", 'szöveg2'];
/* console.log(tomb[3])
...
kiiras(osszeg(123, 321)); // Írjatok függvényt, ami kiszámolja egy téglalap területét!
...
var szorzat = function szorzat(a, b) {
  var szorzas = a * b;
  return szorzas;
};

console.log("A két szám szorzata: ", szorzat(5, 7)); // Nyílfüggvénnyel fűzzünk össze két szöveget és írjuk is ki!
// Elemek elérése
// ID

var elsoSzoveg = document.getElementById("szoveg1");
...
document.getElementById("szoveg2").style.border = "2px solid blue"; // JS-ből egy h1-es elembe írjunk szöveget!

document.getElementById("szoveg3").innerHTML = "Harmadik szöveg";
document.getElementById("szoveg3").style.backgroundImage = "url(img/tax-g7e3a5b7af_1920.jpg)"; // class

var lista = document.getElementsByClassName("lista1");
...
lista[lista.length - 1].style.color = "red"; // tag neve

var tablazat = document.getElementsByTagName("td");
...
function kattintas() {
  var gomb = document.getElementsByTagName("button");
  gomb[0].style.backgroundColor = "blue";
}

function szovegValt() {
  var szoveg3 = document.getElementById("szoveg3");
...
function valt() {
  ...
  console.log(kep.src);
  var utvonal = kep.getAttribute("src");
  console.log(utvonal);
...
function osszead() {
  var a = Number(document.getElementById("elsoszam").value);
  var b = Number(document.getElementById("masodikszam").value);
  document.getElementById("clickkiiras").innerHTML = a + b;
}
...
function rahuz() {
  document.getElementById("rahuzgomb").style.backgroundColor = "green"; // alert("Mit csinálsz?")
}
